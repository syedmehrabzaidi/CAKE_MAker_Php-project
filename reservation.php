...
<div class="content" onclick="remove_class()">
	...
	<div class="inner_content">
		...
		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="hr_book_form">
			...
			<h2 class="form_head"><span class="book_icon">Check Air Pollution Level Here</span></h2>
			<p class="form_slg">We offer you the best Online Cakes reservation</p>
			...
			<div class="left">
				...
				<div class="form_group">
					 ...
					 <label>No of Pounds</label>
					<input type="number" placeholder="No of pounds" min="1" name="guest" id="guest" required>
			...
			<div class="left">
				...
				<div class="form_group">
                    ...
                    <label> Complete Delivery Address <small><b> & any Suggestions(E.g Write Any Name, Flavours etc)</b></small></label>
					<textarea name="suggestions" placeholder="Your Address & Suggestions here" required></textarea>
					
				</div>
				
				<div class="form_group">
					
					<input type="submit" class="submit" name="submit" value="Reserve Your Cake" />
