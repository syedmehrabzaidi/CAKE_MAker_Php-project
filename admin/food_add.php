        ...
        <nav class="navbar navbar-default navbar-fixed" style="background: #521038f2;">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #fff;">Admin | <?php echo $_SESSION["username"]  ?></a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add New Cakes</h4>
                            </div>
                            <div class="content">
                                <form method="post" action="food_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="category" class="form-control" required />
													...
													<option value="breakfast">birthday</option>
													<option value="lunch">anniversiery</option>
													<option value="dinner">happy new year</option>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label style="color: #333">Cake Name</label>
                                                <input type="text" autofocus name="name" class="form-control" placeholder="Enter Cake Name" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" id="price" class="form-control" placeholder="Enter Cake Price" required />
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="txtarea" class="form-control" placeholder="Enter Cake description" name="desc" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" name="submit" style="background: #521038f2; border: 1px solid black" value="Add Cake" class="btn btn-info btn-fill pull-right" />
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <?php echo strftime("%Y", time())?> <a href="index.php" style="color: #521038f2">Unique Restaurant</a>
                </p>
            </div>
        </footer>
