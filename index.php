	...
	if($get_recent->num_rows) {
		...
		while($row = $get_recent->fetch_assoc()) {
			...
			$result .= "<div class='parallax_item'>
							...
							<a href='detail.php?fid=".$row['id']."'><img src='image/FoodPics/".$row['id'].".jpg' width='180px' height='180px' margin-left='800px' /> 
							<div class='detail'>
...
<div class="parallax" onclick="remove_class()">
	...
	<div class="parallax_head">
		...
		<h2>Wellcome Our Air Pollution System</h2>
		<br>
...
<div class="content" onclick="remove_class()">
	...
	<a href="reservation.php" class="submit">Reserve Your Cake</a>
